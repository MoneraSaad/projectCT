...
import "./SettingsPageAccompanyingPerson.css";
...
function SettingsPageAccompanyingPerson() {
    ...
    function handleEdit() {
        ...
        fetch('/api/users/editPersonalInfoForAccompanyingPerson', {
            method: 'POST',
...
export default SettingsPageAccompanyingPerson;