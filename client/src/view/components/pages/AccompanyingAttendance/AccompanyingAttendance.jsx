...
function AccompanyingAttendance() {
    ...
    function getvalue(e) {
        ...
        fetch('/api/users/AccompanyingAttendance', {
            method: "POST",
            body: JSON.stringify({ myCheckBox, AccompanyingPerson }),
            headers: {
            ...
            .then((data) => {
                ...
                if (data.success) {
                    alert("Your attendance status successfully updeted");
                }

                else {
                    alert("!!can't update your status!!");
                }
    ...
    return (
        ...
        <div >
            <Container fluid style={{ color: "white", border: "solid #ffa500", borderColor: "#ffa500", textAlign: "center", background: `url('${process.env.PUBLIC_URL}/l.png')` }}>
                ...
                <h4 style={{ fontWeight: "bold", color: "#ffa500", fontSize: "40px", fontFamily: "Times New Roman" }}>Accompanying Person Attendance</h4><br></br>
...
export default AccompanyingAttendance;